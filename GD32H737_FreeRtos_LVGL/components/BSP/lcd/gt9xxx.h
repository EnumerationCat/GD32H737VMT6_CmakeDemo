...
#define GT9XXX_RST_GPIO_CLK             RCU_GPIOB     /* GPIOB时钟使能 */

#define GT9XXX_INT_GPIO_PORT            GPIOB
#define GT9XXX_INT_GPIO_PIN             GPIO_PIN_13
#define GT9XXX_INT_GPIO_CLK             RCU_GPIOB     /* GPIOB时钟使能 */
...
#define GT9XXX_RST(x)    		 do{ x ? \
                                 gpio_bit_write(GT9XXX_RST_GPIO_PORT, GT9XXX_RST_GPIO_PIN, SET) : \
                                 gpio_bit_write(GT9XXX_RST_GPIO_PORT, GT9XXX_RST_GPIO_PIN, RESET); \
                             }while(0) 	                                                      /* 复位引脚 */

#define GT9XXX_INT    		   gpio_input_bit_get(GT9XXX_INT_GPIO_PORT, GT9XXX_INT_GPIO_PIN)		/* 中断引脚 */	
